...
namespace UCenterApi
{
    ...
    {
        public IUcConfig UcConfig { get; set; }

        public UcUtility(IUcConfig ucConfig)
        {
        ...
        /// <returns></returns>
        private string authCode(string sourceStr, AuthCodeMethod operation, string keyStr, int expiry = 0)
        {
        ...
        /// <returns></returns>
        private string check(byte[] keyb, byte[] result)
        {
        ...
        /// <returns></returns>
        private byte[] getResult(IList<byte> source, IList<int> box, int sourceLength)
        {
        ...
        private void rndBox(IList<int> box, IList<int> rndkey)
        {
        ...
        /// <returns></returns>
        public string AuthCodeDecode(string str)
        {
        ...
        /// <returns></returns>
        public string AuthCodeDecode(string str, string key)
        {
        ...
        /// <returns></returns>
        public string AuthCodeDecode(string str, string key, int expiry)
        {
        ...
        /// <param name="str">字符串</param>
        /// <returns></returns>
        public string AuthCodeEncode(string str)
        {
        ...
        /// <param name="key">UC KEY</param>
        /// <returns></returns>
        public string AuthCodeEncode(string str, string key)
        {
        ...
        /// <param name="expiry">过期时间 0代表永不过期</param>
        /// <returns></returns>
        public string AuthCodeEncode(string str, string key, int expiry)
        {
        ...
        {
            //TODO: return (HttpContext.Current != null) ? HttpContext.Current.Request.ServerVariables["Http_User_Agent"] : "Mozilla/4.0(compatible;MSIE6.0;)";
            string userAgent = "Mozilla/4.0(compatible;MSIE6.0;)";
        ...
        /// <param name="str">字符串</param>
        /// <returns></returns>
        public string PhpUrlEncode(string str)
        {
